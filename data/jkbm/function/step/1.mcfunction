...
execute if block ~ ~ ~ #wooden_shelves run function jkbm:step/type/wooden_shelves
execute unless block ~ ~ ~ decorated_pot unless block ~ ~ ~ #wooden_shelves run function jkbm:step/type/_global
...
item modify entity @s container.0 {function: "set_lore", entity: "this", mode: "replace_all", lore: [[{storage: "jk:bm", nbt: "txt.lore.pack_by_bm", interpret: true, italic: false, color: "gray"}]]}
